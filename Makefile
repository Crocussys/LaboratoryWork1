#############################################################################
# Makefile for building: LaboratoryWork1
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  ../LaboratoryWork1/LaboratoryWork1.pro
# Template: app
# Command: /home/egor/Qt/5.15.2/gcc_64/bin/qmake -o Makefile ../LaboratoryWork1/LaboratoryWork1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../LaboratoryWork1 -I. -I../../../Qt/5.15.2/gcc_64/include -I../../../Qt/5.15.2/gcc_64/include/QtCore -I. -I../../../Qt/5.15.2/gcc_64/mkspecs/linux-g++
QMAKE         = /home/egor/Qt/5.15.2/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/egor/Qt/5.15.2/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/egor/Qt/5.15.2/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = LaboratoryWork11.0.0
DISTDIR = /home/egor/Документы/c/build-LaboratoryWork1-Desktop_Qt_5_15_2_GCC_64bit-Debug/.tmp/LaboratoryWork11.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/egor/Qt/5.15.2/gcc_64/lib
LIBS          = $(SUBLIBS) /home/egor/Qt/5.15.2/gcc_64/lib/libQt5Core.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = ../LaboratoryWork1/database.cpp \
		../LaboratoryWork1/main.cpp \
		../LaboratoryWork1/menu.cpp \
		../LaboratoryWork1/product.cpp 
OBJECTS       = database.o \
		main.o \
		menu.o \
		product.o
DIST          = ../../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../LaboratoryWork1/LaboratoryWork1.pro ../LaboratoryWork1/database.h \
		../LaboratoryWork1/menu.h \
		../LaboratoryWork1/product.h ../LaboratoryWork1/database.cpp \
		../LaboratoryWork1/main.cpp \
		../LaboratoryWork1/menu.cpp \
		../LaboratoryWork1/product.cpp
QMAKE_TARGET  = LaboratoryWork1
DESTDIR       = 
TARGET        = LaboratoryWork1


first: all
####### Build rules

LaboratoryWork1:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ../LaboratoryWork1/LaboratoryWork1.pro ../../../Qt/5.15.2/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt/5.15.2/gcc_64/mkspecs/common/unix.conf \
		../../../Qt/5.15.2/gcc_64/mkspecs/common/linux.conf \
		../../../Qt/5.15.2/gcc_64/mkspecs/common/sanitize.conf \
		../../../Qt/5.15.2/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../../Qt/5.15.2/gcc_64/mkspecs/features/yacc.prf \
		../../../Qt/5.15.2/gcc_64/mkspecs/features/lex.prf \
		../LaboratoryWork1/LaboratoryWork1.pro
	$(QMAKE) -o Makefile ../LaboratoryWork1/LaboratoryWork1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../LaboratoryWork1/database.h ../LaboratoryWork1/menu.h ../LaboratoryWork1/product.h $(DISTDIR)/
	$(COPY_FILE) --parents ../LaboratoryWork1/database.cpp ../LaboratoryWork1/main.cpp ../LaboratoryWork1/menu.cpp ../LaboratoryWork1/product.cpp $(DISTDIR)/
...
database.o: ../LaboratoryWork1/database.cpp ../LaboratoryWork1/database.h \
		../LaboratoryWork1/product.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o database.o ../LaboratoryWork1/database.cpp

main.o: ../LaboratoryWork1/main.cpp ../../../Qt/5.15.2/gcc_64/include/QtCore/QCoreApplication \
		...
		../LaboratoryWork1/database.h \
		../LaboratoryWork1/product.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../LaboratoryWork1/main.cpp

menu.o: ../LaboratoryWork1/menu.cpp ../LaboratoryWork1/menu.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o menu.o ../LaboratoryWork1/menu.cpp

product.o: ../LaboratoryWork1/product.cpp ../LaboratoryWork1/product.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o product.o ../LaboratoryWork1/product.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/LaboratoryWork1/bin || mkdir -p $(INSTALL_ROOT)/opt/LaboratoryWork1/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/LaboratoryWork1/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/LaboratoryWork1/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/LaboratoryWork1/bin/ 
